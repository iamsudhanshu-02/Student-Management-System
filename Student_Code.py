...
exlist={'Bhagya':'Information Tech','Purvesh':'Computers','Ronak':'Finance','Sudhanshu':'MBA-Tech',
        'Aryak':'MBA-Tech','Akshay':'Robotics','Sagarika':'Business Intelligence & Analytics','Sameer':'Electronics','Sagar':'Robotics'}
